...
class EyeInHandCalibration extends BaseCalibration {
    ...
    async updateParameters() {
        ...
        const parameters = {
            ...
            chessboard_x: parseInt(document.getElementById('chessboard-x')?.value || 11),
            chessboard_y: parseInt(document.getElementById('chessboard-y')?.value || 8),
            square_size: parseFloat(document.getElementById('square-size')?.value || 0.02),
